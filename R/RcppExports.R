...
cache_samc_cpp <- function(kernel, permeability, fidelity, absorbtion) {
    .Call('_LSTDConnect_cache_samc', PACKAGE = 'LSTDConnect', kernel, permeability, fidelity, absorbtion)
}
